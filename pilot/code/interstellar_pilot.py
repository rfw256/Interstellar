...
def init_pilot_params(expParams):
    ...
    return trialParams, saccade_data, timestr
...
def write_data(contrast_data, expParams, session_folder, nPressed, timestr):
...
def run_experiment(expParams):
    ...
    trialParams, saccade_data, timestr = init_pilot_params(expParams)
    contrast_data = {}
    nPressed = -1
    ...
    write_data(contrast_data, expParams, session_folder, nPressed, timestr)
